...
>
> ![Python](https://img.shields.io/badge/Python-3.9+-blue) ![Streamlit](https://img.shields.io/badge/App-Streamlit-red) ![Status](https://img.shields.io/badge/Status-Portfolio_MVP-green) ![Responsible AI](https://img.shields.io/badge/Responsible_AI-Documented-purple) ![License](https://img.shields.io/badge/License-MIT-lightgrey)
>
...
> | | |
> |---|---|
> | **Role fit** | Data Analyst · Junior Data Scientist · AI Product Analyst · Sustainability Data Analyst |
...
>
> This project demonstrates how data science can support climate adaptation decisions, not just prediction. It shows how open public datasets can be combined into a practical decision-support tool for housing, health, sustainability and local policy teams.
>
> ---
>
> ## Skills demonstrated
>
> - Data collection from public APIs and open datasets
> - - Large EPC data processing (3.6M rows) and quality checks
>   - - Feature engineering for climate and housing risk
>     - - Explainable risk scoring and Random Forest interpretation
>       - - Streamlit dashboard design across 8 pages
>         - - Responsible AI documentation
>           - - Communicating uncertainty and data limitations clearly
>            
>             - ---
>
> ## What surprised me
